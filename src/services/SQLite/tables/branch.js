    ...
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        error => {
          ...
          console.log(`error on create ${GText.infoDB.Table.Branch.name} ` + error.message);
        },
      );
    });
  });
  ...
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        error => {
          reject(error.message)
          console.log(`error on update ${GText.infoDB.Table.Branch.name} ` + error.message);
        },
      );
    });
  });
  ...
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        error => {
          reject(error.message)
          console.log(`error on find ${GText.infoDB.Table.Branch.name} ` + error.message);
        }
      );
    });
  });
  ...
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        error => {
          reject(error.message)
          console.log(`error on finBy ${GText.infoDB.Table.Branch.name} ` + error.message);
        }
      );
    });
  });
  ...
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        error => {
          reject(error.message)
          console.log(`error on removeById ${GText.infoDB.Table.Branch.name} ` + error.message);
        }
      );
    });
  });
