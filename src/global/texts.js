...
export const HourFormat = (
  DataNow.getHours().toString() +
  ":" +
  DataNow.getMinutes().toString()
).toString();
...
const GText = {
  ...
  labelModalLogoff: {
    ...
    message:
      "Seus dados não sincronizados serão descartados, tem certeza que deseja sair?",
    buttonLeft: "Voltar",
    buttonRight: "Sair",
  },
  labelModalSelectServer: {
    ...
    message:
      "Este servidor será definido e utilizado como padrão, deseja continuar?",
    buttonLeft: "Voltar",
  ...
  labelModalDeleteColetaHome: {
    ...
    message:
      "Essa coleta ainda não foi enviada, tem certeza que deseja excluir?",
    buttonLeft: "Voltar",
    buttonRight: "Deletar",
  },
  labelModalDeleteColetasHome: {
    ...
    message:
      "Essas coletas ainda não foram enviadas, tem certeza que deseja excluir?",
    buttonLeft: "Voltar",
    buttonRight: "Deletar",
  },
  labelModalCancelSendedItem: {
    ...
    message:
      "Essa coleta ficará indisponível para uso no retaguarda, tem certeza que deseja cancelar?",
    buttonLeft: "Voltar",
  ...
  labelModalCancelSendedItens: {
    title: "Cancelar Coleta",
    message:
      "As coletas ficarão indisponíveis para uso no retaguarda, tem certeza que deseja cancelar?",
    buttonLeft: "Voltar",
    buttonRight: "Cancelar",
  },
...
export function NameTables(params) {
  ...
  for (let prop in BaseForm) {
    if (
      (BaseForm[prop].name !== BaseForm.Log.name) &
